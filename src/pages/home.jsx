  ...
  return (
    <View style={style.hero}>
      ...
      <View style={style.title}>
        <Text style={{color: '#A4A4A4', fontSize: 25}}>Selamat Datang Di</Text>
        <Text
          style={{
            fontSize: 42,
            fontWeight: 'bold',
        ...
        <View style={style.menu}>
          ...
          <TouchableOpacity>
            <View style={style.descmenu}>
              <Image
                style={style.fotomakan}
                source={require('../assets/images/unsplash_i5XurHSjE1M.png')}
              />
        ...
        <View style={style.menu}>
          <TouchableOpacity>
            <View style={style.descmenu}>
              <Image
                style={style.fotomakan}
                source={require('../assets/images/unsplash_8h6L01Httpw.png')}
              />
          ...
          <TouchableOpacity>
            <View style={style.descmenu}>
              <Image
                style={style.fotomakan}
                source={require('../assets/images/unsplash_kbch-i63YTg.png')}
              />
